...
const Header = () => {
	...
	return (
		<header className="w-full h-auto sticky top-0 z-50 bg-white shadow-md"> 
			<div className="container mx-auto flex">
				...
				<nav className="w-full md:w-auto h-auto grid grid-cols-5 md:flex text-center text-sm font-light">
					...
					<Link href="/profile" className="px-4 pt-3 pb-2 block">
						<img className="m-auto rounded-full" height="22px" width="22px" src="profile.jpg" alt="Profile" />
